#ifndef WFORGE_XOROSHIRO_H
#define WFORGE_XOROSHIRO_H
...
struct Seed {
	...
	static Seed from_string(const char *str) noexcept;
...
public:
	 ...
	 */
	Xoroshiro128PP jump_64() const noexcept;
	 ...
	 */
	Xoroshiro128PP jump_96() const noexcept;
